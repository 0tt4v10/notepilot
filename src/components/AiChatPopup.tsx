                ...
                <div className="flex flex-col gap-1.5 w-full mt-1">
                  {t.popup_prompts.map(s => (
                    <button
                      key={s}
                      onClick={() => setInput(s)}
                      className="text-xs text-left px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-700 hover:bg-blue-50 dark:hover:bg-blue-900/40 hover:text-blue-600 dark:hover:text-blue-300 text-slate-500 dark:text-slate-400 transition border border-slate-100 dark:border-slate-600"
                    >
                      {s}
                    </button>
                  ))}
